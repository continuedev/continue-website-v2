        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="shrink-0 mr-4">
            ...
            <Link href="/" className="block" aria-label="Cruip">
              <svg
                className="w-48 h-48 fill-current white"
                viewBox="0 0 736 178"
                fill="none"
              ...
              >
                ...
                <rect x="33.0" y="38.4004" width="17.4" height="88.5818" />
                <rect x="48.0" y="57.3809" width="17.4" height="52.2" />
                <rect x="64.0" y="74.7812" width="17.4" height="17.4" />
              </svg>
            </Link>
          </div>
